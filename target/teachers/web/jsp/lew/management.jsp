                ...
                <ul class="nav navbar-nav">
                    <li class="user user-menu">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="hidden-xs">${user.uCodeE}</span>
                        </a>
                    </li>
                    <li class="user user-menu">
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                <li class="active"><a href="${pageContext.request.contextPath}s/w/management"><span>单位管理</span></a></li>
                <li><a href="${pageContext.request.contextPath}/w/-1/-1/table-management"><span>表格管理</span></a></li>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <form id="excel_upload" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/w/excel_upload">
                                ...
                                <a href="${pageContext.request.contextPath}/w/users" class="btn btn-default btn-file" >
                                    导出通讯录
                                </a>
                        ...
                        <div class="box-body">
                            <table class="table table-bordered">
                                ...
                                <c:forEach items="${users}" var="user"    varStatus="id">
                                    <tr>
                                        <td>${user.uName}</td>
                                        <td>${user.uCodeE} ${user.uCodeW}</td>
                                        <td>${user.uV2Name}</td>
                                        <td>${user.uV2Phone}</td>
                                        <td>${user.uV2Email}</td>
                                        <td>
                                            <a data-toggle="modal" data-target="#confirm-alert" class="btn btn-default" href="${pageContext.request.contextPath}/w/${user.uId}/recode">重置密码</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
