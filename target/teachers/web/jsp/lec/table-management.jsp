    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree">
                <li ><a href="${pageContext.request.contextPath}/c/management"><span>单位管理</span></a></li>
                <li class="active"><a href="${pageContext.request.contextPath}/c/-1/-1/table-management"><span>表格管理</span></a></li>
                <li><a href="${pageContext.request.contextPath}/c/-1/table-list"><span>汇总统计</span></a></li>
                <li ><a href="${pageContext.request.contextPath}/c/psd"><span>修改密码</span></a></li>
            </ul>
        </section>
    </aside>
...
<script>
    ...
    function f() {
        var url = '${pageContext.request.contextPath}/c/'+document.getElementById('years').value+'/'+document.getElementById('codes').value+'/table-management';
        window.location.href=url;
    }


    function f2(code) {
        document.getElementById('cancel_form').setAttribute("action",'${pageContext.request.contextPath}/c/'+code+'/cancel');
    }
    function f3(code) {
        document.getElementById('cancel_form').setAttribute("action",'${pageContext.request.contextPath}/c/'+code+'/up');
    }
    function  cancel() {
...
<script>
    $("#submit-all-id").on("click",function () {
        ...
        if(idString==''){
            ...
            var url = '${pageContext.request.contextPath}/c/'+idString+'/up_group';
            window.location.href=url;
        }
    });
</script>
