...
<div class="login-box">
    ...
    <div class="login-box-body">
        <form action="${pageContext.request.contextPath}/common/4/register" method="post" enctype='multipart/form-data'  id="reguster2Form">
            <input  id="q" name="q"  hidden="hidden" value="1721">

            <div class="form-group has-feedback">
                <input id="" name="idcode" type="number" class="form-control" placeholder="身份证号(无法修改!请确认!）">
                <%--<span class="glyphicon glyphicon-user form-control-feedback"></span>--%>
            </div>
            <div class="form-group has-feedback">
                <input id="" name="u1UName" type="text" class="form-control" placeholder="姓名">
                <%--<span class="glyphicon glyphicon-user form-control-feedback"></span>--%>
            </div>
            <div class="form-group has-feedback">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <a href="#" class="btn btn-primary btn-block btn-flat" onclick="document.getElementById('reguster2Form').submit();">申请</a>
                </div>
            </div>
