    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/r/-1/-1/table-management2"><span>部署院校表格管理</span></a></li>
                        ...
                        <div class="box-header with-border">
                            ...
                            <select class="form-control" id="codes">
                                <c:forEach items="${users}" var="user"    varStatus="id">
                                    <option value="${user.u1Id}"> ${user.u1ScName} ${user.u1CodeW}</option>
                                </c:forEach>
                                <option value="-1">全部</option>
                            </select>
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach items="${tables}" var="item"    varStatus="id">
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${item.tableCopyCopy.tIfEOk==1}"> -- </c:if>
                                            <c:if test="${item.tableCopyCopy.tIfEOk==2}"> 通过 </c:if>
                                            <c:if test="${item.tableCopyCopy.tIfEOk==3}"> 被驳回 </c:if></td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/common/${item.tableCopyCopy.tId}/statics2" target="_blank" class="btn btn-default">查看详情</a>
                                            <c:if test="${item.tableCopyCopy.tIfEOk==1}">
