    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/r/management3"><span>个体教师账号管理</span></a></li>
                        ...
                        <div class="box-header with-border">
                            <form id="excel_upload" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/r/excel_upload">
                                <%--<a href="javascript:;" class="btn btn-default btn-file" onclick="document.getElementById('excel_upload').submit();">
                                    ...
                                    <a href="${pageContext.request.contextPath}/r/4/users" class="btn btn-default btn-file" >
                                        导出通讯录
                                    </a>
                            </form>
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach items="${users}" var="user"    varStatus="id">
                                    <tr>
                                        ...
                                        <td>
                                            <a data-toggle="modal" data-target="#confirm-alert" class="btn btn-default" href="${pageContext.request.contextPath}/r/${user.u2Id}/recode3">重置密码</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
