                ...
                <ul class="nav navbar-nav">
                    <li class="user user-menu">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="hidden-xs">${user.uCodeQ}</span>
                        </a>
                    </li>
                    <li class="user user-menu">
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                <li class="active"><a href="${pageContext.request.contextPath}/b/management"><span>单位管理</span></a></li>
                <li><a href="${pageContext.request.contextPath}/b/-1/-1/table-management"><span>表格管理</span></a></li>
...
--%>
                                <a href="${pageContext.request.contextPath}/b/users" class="btn btn-default btn-file" >
                                    导出通讯录
                                </a>
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach items="${users}" var="user"    varStatus="id">
                                    <tr>
                                        ...
                                        <td>${user.uV2Email}</td>
                                        <td>
                                            <a data-toggle="modal" data-target="#confirm-alert" class="btn btn-default" href="${pageContext.request.contextPath}/b/${user.uId}/recode">重置密码</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
