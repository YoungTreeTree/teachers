    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/t/-1/table-list"><span>汇总统计</span></a></li>
...
<script>
    ...
    function f() {
        var url = '${pageContext.request.contextPath}/t/'+document.getElementById('year').value+'/table-list';
        window.location.href=url;
    }
    function f2() {
        var url = '${pageContext.request.contextPath}/t/'+document.getElementById('year').value+'/downloadFile';
        window.location.href=url;
    }
</script>
