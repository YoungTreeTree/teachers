    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/y/history"><span>历史表格</span></a></li>
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach items="${tables}" var="item"    varStatus="id">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/y/${item.tId}/detail" target="_blank" class="btn btn-default">查看</a>
                                        </td>
                                    </tr>
                                </c:forEach>
