    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                <li class="active"><a href="${pageContext.request.contextPath}/y/table"><span>表格录入</span></a></li>
                <li><a href="${pageContext.request.contextPath}/y/history"><span>历史表格</span></a></li>
                <li><a href="${pageContext.request.contextPath}/y/psd"><span>修改密码</span></a></li>
            </ul>
        </section>
    </aside>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-body">
                            <form id="table_up_form" enctype='multipart/form-data' method="post" action="${pageContext.request.contextPath}/y/up_table">
