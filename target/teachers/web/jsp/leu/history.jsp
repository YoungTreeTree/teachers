    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/u/history"><span>历史表格</span></a></li>
                <li><a href="${pageContext.request.contextPath}/u/psd"><span>修改个人信息</span></a></li>
            </ul>
        </section>
    </aside>
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach items="${tables}" var="item"    varStatus="id">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/u/${item.tId}/detail" target="_blank" class="btn btn-default">查看</a>
                                        </td>
                                    </tr>
                                </c:forEach>
