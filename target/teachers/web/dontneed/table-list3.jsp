    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/r/-1/table-list3"><span>个体教师汇总统计</span></a></li>
...
<script>
    ...
    function f() {
        var url = '${pageContext.request.contextPath}/r/'+document.getElementById('year').value+'/table-list3';
        window.location.href=url;
    }
    function f2() {
        var url = '${pageContext.request.contextPath}/r/'+document.getElementById('year').value+'/downloadFile3';
        window.location.href=url;
    }
</script>
