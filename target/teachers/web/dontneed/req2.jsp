    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li  class="active"><a href="${pageContext.request.contextPath}/r/req2"><span>部署院校账号申请</span></a></li>
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach items="${users}" var="user"    varStatus="id">
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-default"  href="${pageContext.request.contextPath}/r/${user.u1Id}/ok2">账号申请通过</a>
                                            <a  class="btn btn-default" href="${pageContext.request.contextPath}/r/${user.u1Id}/nook2">账号申请驳回</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
