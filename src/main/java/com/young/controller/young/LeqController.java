...
import com.young.services.le_q.impl.LeqServiceImpl;
...
public class LeqController extends BaseController {
    @Resource
    private LeqServiceImpl leqService;
    ...
    public ModelAndView management() throws Exception {
        ...
        ArrayList<User> users = leqService.get_users_by_pre_code(user.getuCodeW(),user.getuCodeE());
        modelAndView.getModel().put("user",user);
        modelAndView.getModel().put("users",users);
        modelAndView.setViewName("leq/management");
        return modelAndView;
    }
    ...
    public ModelAndView table_management_detail(
        ...
        modelAndView.setViewName("/leq/table-management");
        return modelAndView;
    }
    ...
    public ModelAndView table_list(
        ...
        modelAndView.getModel().put("years",years);
        modelAndView.getModel().put("year",year);
        modelAndView.setViewName("/leq/table-list");
        return modelAndView;
    }
    ...
    public ModelAndView psd(
        ...
        modelAndView.setViewName("/leq/psd");
        return modelAndView;
    }
    ...
    public ModelAndView cancel(
        ...
        if (recode == 1){
            ...
            modelAndView.getModel().put("url","/q/-1/-1/table-management");
            modelAndView.setViewName("return");
        }else{
    ...
    private void  downloadFile3(
        ...
        try {
            ...
            String path =  FileUtil.creat_file_static(year,tables,filePath,fileName);
    ...
    public ModelAndView change_pw(
        ...
        if (!new_pw1.equals(new_pw)){
            ...
            modelAndView.getModel().put("url","/leq/psd");
            modelAndView.setViewName("return");
            return modelAndView;
        }
        User user =getUserSession();
