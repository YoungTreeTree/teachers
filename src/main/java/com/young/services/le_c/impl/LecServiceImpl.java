package com.young.services.le_c.impl;

import com.young.entity.TableCopy;
import com.young.entity.User;
import com.young.services.common.impl.CommServiceImpl;
import com.young.services.le_b.ILebService;
import com.young.services.le_c.ILecService;
...
public class LecServiceImpl extends CommServiceImpl implements ILecService {

    @Override
    public ArrayList<TableCopy> get_table_by_year_user(String year, User user) {
        ArrayList<TableCopy> reList = new ArrayList<>();
        if(year.equals("-1")){
            ArrayList<User> users = get_users_by_pre_code(user.getuV2Phone());
            for (User u:users
                    ) {
                Map map = new HashMap();
    ...
    @Override
    public ArrayList<User> get_users_by_pre_code(String phone) {
        Map map = new HashMap();
        map.put("uCodeQ",phone);
        map.put("uType",1);
