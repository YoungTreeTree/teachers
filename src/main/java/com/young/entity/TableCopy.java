...
@Entity
@Table(name = "table_copy", schema = "teachers2", catalog = "")
public class TableCopy {
    ...
    public boolean equals(Object o) {
        ...
        TableCopy tableCopy = (TableCopy) o;

        if (tId != tableCopy.tId) return false;
        if (tName != null ? !tName.equals(tableCopy.tName) : tableCopy.tName != null) return false;
        if (tIdCard != null ? !tIdCard.equals(tableCopy.tIdCard) : tableCopy.tIdCard != null) return false;
        if (tChinaQ != null ? !tChinaQ.equals(tableCopy.tChinaQ) : tableCopy.tChinaQ != null) return false;
        if (tChinaW != null ? !tChinaW.equals(tableCopy.tChinaW) : tableCopy.tChinaW != null) return false;
        if (tChinaE != null ? !tChinaE.equals(tableCopy.tChinaE) : tableCopy.tChinaE != null) return false;
        if (tWorldQ != null ? !tWorldQ.equals(tableCopy.tWorldQ) : tableCopy.tWorldQ != null) return false;
        if (tWorldQE != null ? !tWorldQE.equals(tableCopy.tWorldQE) : tableCopy.tWorldQE != null) return false;
        if (tWorldW != null ? !tWorldW.equals(tableCopy.tWorldW) : tableCopy.tWorldW != null) return false;
        if (tWorldWE != null ? !tWorldWE.equals(tableCopy.tWorldWE) : tableCopy.tWorldWE != null) return false;
        if (tWorldE != null ? !tWorldE.equals(tableCopy.tWorldE) : tableCopy.tWorldE != null) return false;
        if (tWorldEE != null ? !tWorldEE.equals(tableCopy.tWorldEE) : tableCopy.tWorldEE != null) return false;
        if (tPhone != null ? !tPhone.equals(tableCopy.tPhone) : tableCopy.tPhone != null) return false;
        if (tMail != null ? !tMail.equals(tableCopy.tMail) : tableCopy.tMail != null) return false;
        if (tWho != null ? !tWho.equals(tableCopy.tWho) : tableCopy.tWho != null) return false;
        if (tZuoji != null ? !tZuoji.equals(tableCopy.tZuoji) : tableCopy.tZuoji != null) return false;
        if (tAddress != null ? !tAddress.equals(tableCopy.tAddress) : tableCopy.tAddress != null) return false;
        if (tEms != null ? !tEms.equals(tableCopy.tEms) : tableCopy.tEms != null) return false;
        if (tIfGo != null ? !tIfGo.equals(tableCopy.tIfGo) : tableCopy.tIfGo != null) return false;
        if (tGoReason != null ? !tGoReason.equals(tableCopy.tGoReason) : tableCopy.tGoReason != null) return false;
        if (tIfQOk != null ? !tIfQOk.equals(tableCopy.tIfQOk) : tableCopy.tIfQOk != null) return false;
        if (tIfWOk != null ? !tIfWOk.equals(tableCopy.tIfWOk) : tableCopy.tIfWOk != null) return false;
        if (tIfEOk != null ? !tIfEOk.equals(tableCopy.tIfEOk) : tableCopy.tIfEOk != null) return false;
        if (tQNoReason != null ? !tQNoReason.equals(tableCopy.tQNoReason) : tableCopy.tQNoReason != null) return false;
        if (tWNoReason != null ? !tWNoReason.equals(tableCopy.tWNoReason) : tableCopy.tWNoReason != null) return false;
        if (tENoReason != null ? !tENoReason.equals(tableCopy.tENoReason) : tableCopy.tENoReason != null) return false;
        if (tNumber != null ? !tNumber.equals(tableCopy.tNumber) : tableCopy.tNumber != null) return false;
        if (tDateY != null ? !tDateY.equals(tableCopy.tDateY) : tableCopy.tDateY != null) return false;
        if (tDateM != null ? !tDateM.equals(tableCopy.tDateM) : tableCopy.tDateM != null) return false;
        if (tDateD != null ? !tDateD.equals(tableCopy.tDateD) : tableCopy.tDateD != null) return false;
        if (tStartY != null ? !tStartY.equals(tableCopy.tStartY) : tableCopy.tStartY != null) return false;
        if (tStartM != null ? !tStartM.equals(tableCopy.tStartM) : tableCopy.tStartM != null) return false;
        if (tStartD != null ? !tStartD.equals(tableCopy.tStartD) : tableCopy.tStartD != null) return false;
        if (tEndY != null ? !tEndY.equals(tableCopy.tEndY) : tableCopy.tEndY != null) return false;
        if (tEndM != null ? !tEndM.equals(tableCopy.tEndM) : tableCopy.tEndM != null) return false;
        if (tEndD != null ? !tEndD.equals(tableCopy.tEndD) : tableCopy.tEndD != null) return false;
        if (uId != null ? !uId.equals(tableCopy.uId) : tableCopy.uId != null) return false;
        if (tIfTemp != null ? !tIfTemp.equals(tableCopy.tIfTemp) : tableCopy.tIfTemp != null) return false;
        if (tUserInputYear != null ? !tUserInputYear.equals(tableCopy.tUserInputYear) : tableCopy.tUserInputYear != null)
            return false;
