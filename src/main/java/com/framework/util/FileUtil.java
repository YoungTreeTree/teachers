...
public class FileUtil {
    ...
    public static String creat_file_static(String year , ArrayList<TableCopy> tableCopies, String path, String filename) throws Exception {
        //创建workbook
...
//设置样式
        ...
        c3_6.setCellValue(new HSSFRichTextString("赴任国家（中文）"));
        HSSFCell c3_7 = row3.createCell(7);
        c3_7.setCellValue(new HSSFRichTextString("国外岗位名称（中文）"));
        HSSFCell c3_8 = row3.createCell(8);
        c3_8.setCellValue(new HSSFRichTextString("赴任国家（英文）"));
        HSSFCell c3_9 = row3.createCell(9);
        c3_9.setCellValue(new HSSFRichTextString("国外岗位名称（英文）"));
        HSSFCell c3_10 = row3.createCell(10);
        c3_10.setCellValue(new HSSFRichTextString("申请人手机"));
        HSSFCell c3_11 = row3.createCell(11);
        c3_11.setCellValue(new HSSFRichTextString("申请人邮箱"));
        HSSFCell c3_12 = row3.createCell(12);
        c3_12.setCellValue(new HSSFRichTextString("单位联系人"));
        HSSFCell c3_13 = row3.createCell(13);
        c3_13.setCellValue(new HSSFRichTextString("联系人电话"));
        HSSFCell c3_14 = row3.createCell(14);
        c3_14.setCellValue(new HSSFRichTextString("邮寄地址（有单位填写单位地址）"));
        HSSFCell c3_15 = row3.createCell(15);
        c3_15.setCellValue(new HSSFRichTextString("邮编"));

        HSSFCell c3_16 = row3.createCell(16);
        c3_16.setCellValue(new HSSFRichTextString("是否提前离任"));

        HSSFCell c3_17 = row3.createCell(17);
        ...
        for (TableCopy tc:tableCopies
            ...
            c4_6.setCellValue(new HSSFRichTextString(tc.gettWorldQ()+" "+tc.gettWorldW()));

            HSSFCell c4_7 = row4.createCell(7);
            c4_7.setCellValue(new HSSFRichTextString(tc.gettWorldE()));

            HSSFCell c4_8 = row4.createCell(8);
            c4_8.setCellValue(new HSSFRichTextString(tc.gettWorldQE()+" "+tc.gettWorldWE()));
            ...
            HSSFCell c4_17 = row4.createCell(17);
    ...
    public static String creat_file_static2(String year , ArrayList<TableCopy> tableCopies, String path, String filename) throws Exception {
        //创建workbook
        HSSFWorkbook workbook = new HSSFWorkbook();
        //创建sheet页
        HSSFSheet sheet = workbook.createSheet("统计表");
...
//设置样式
        ...
        HSSFCell c3_18 = row3.createCell(18);
        c3_18.setCellValue(new HSSFRichTextString("教育厅审批意见"));
        ...
        for (TableCopy tc:tableCopies
            ...
            HSSFCell c4_18 = row4.createCell(18);
            c4_18.setCellValue(new HSSFRichTextString(tc.gettWNoReason()));
    ...
    public static String creat_file_static3(String year , ArrayList<TableCopy> tableCopies, String path, String filename) throws Exception {
        //创建workbook
        HSSFWorkbook workbook = new HSSFWorkbook();
        //创建sheet页
        HSSFSheet sheet = workbook.createSheet("统计表");
...
//设置样式
        ...
        HSSFCell c3_19 = row3.createCell(19);
        c3_19.setCellValue(new HSSFRichTextString("汉办审批意见"));

        HSSFCell c3_20= row3.createCell(20);
        c3_20.setCellValue(new HSSFRichTextString("证书编号"));

        HSSFCell c3_21 = row3.createCell(21);
        c3_21.setCellValue(new HSSFRichTextString("证书发放时间"));
        ...
        for (TableCopy tc:tableCopies
            ...
            HSSFCell c4_19 = row4.createCell(19);
            c4_19.setCellValue(new HSSFRichTextString(tc.gettENoReason()));
            HSSFCell c4_20 = row4.createCell(20);
            c4_20.setCellValue(new HSSFRichTextString(tc.gettNumber()));
            HSSFCell c4_21 = row4.createCell(21);
            c4_21.setCellValue(new HSSFRichTextString(tc.gettDateY()+"-"+tc.gettDateM()+"-"+tc.gettDateD()));
    ...
    public static String creat_file_static4(String year , ArrayList<TableCopyCopy> tableCopies, String path, String filename) throws Exception {
        //创建workbook
        HSSFWorkbook workbook = new HSSFWorkbook();
        //创建sheet页
        HSSFSheet sheet = workbook.createSheet("统计表");
...
//设置样式
        ...
        int row_num = 2;
        int index = 1;
        for (TableCopyCopy tc:tableCopies
                ) {
            HSSFRow row4 = sheet.createRow(row_num);
    ...
    public static String creat_file_static5(String year , ArrayList<TableCopyCopyCopy> tableCopies, String path, String filename) throws Exception {
        //创建workbook
        HSSFWorkbook workbook = new HSSFWorkbook();
        //创建sheet页
        HSSFSheet sheet = workbook.createSheet("统计表");
...
//设置样式
        ...
        int row_num = 2;
        int index = 1;
        for (TableCopyCopyCopy tc:tableCopies
                ) {
            HSSFRow row4 = sheet.createRow(row_num);
...
//设置样式
        ...
        for (User u:users
            ...
            HSSFCell c4_2 = row4.createCell(2);
            c4_2.setCellValue(new HSSFRichTextString(u.getuCodeE()+" "+u.getuCodeW()+" " +u.getuCodeQ()));
