    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/b/psd"><span>修改密码</span></a></li>
            </ul>
        </section>
    </aside>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="box box-primary">
                        <div class="box-body">
                            <form action="${pageContext.request.contextPath}/b/change_pw" method="post" id="change_pw" enctype='multipart/form-data'>
