    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li><a href="${pageContext.request.contextPath}/d/-1/-1/table-management"><span>表格管理</span></a></li>
                <li><a href="${pageContext.request.contextPath}/d/-1/table-list"><span>汇总统计</span></a></li>
                <li class="active"><a href="${pageContext.request.contextPath}/d/psd"><span>修改密码</span></a></li>
            </ul>
        </section>
    </aside>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="box box-primary">
                        <div class="box-body">
                            <form action="${pageContext.request.contextPath}/d/change_pw" method="post" id="change_pw" enctype='multipart/form-data'>
                                ...
                                <div class="form-group">
                                    <label >联系电话</label>
                                    <input id="phone" name="phone" type="text" class="form-control"   value="${user.uV2Phone}">
                                </div>


                                <div class="form-group">
                                    <label >联系邮箱</label>
                                    <input id="mail" name="mail" type="text" class="form-control"   value="${user.uV2Email}">
                                </div>
                                <div class="form-group">
