    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/r/-1/-1/table-management"><span>省厅表格管理</span></a></li>
                        ...
                        <div class="box-header with-border">
                            ...
                            <select class="form-control" id="codes">
                                <c:forEach items="${users}" var="user"    varStatus="id">
                                    <option value="${user.uId}"> ${user.uCodeE}  ${user.uName}</option>
                                </c:forEach>
                                <option value="-1">全部</option>
                            </select>
...
<script>
    ...
    function f() {
        var url = '${pageContext.request.contextPath}/r/'+document.getElementById('years').value+'/'+document.getElementById('codes').value+'/table-management';
        window.location.href=url;
    }


    function f2(code) {
        document.getElementById('cancel_form').setAttribute("action",'${pageContext.request.contextPath}/r/'+code+'/cancel');
    }
    function f3(code) {
        document.getElementById('cancel_form').setAttribute("action",'${pageContext.request.contextPath}/r/'+code+'/up');
    }
    function  cancel() {
...
<script>
    $("#submit-all-id").on("click",function () {
        ...
        if(idString==''){
            ...
            var url = '${pageContext.request.contextPath}/r/'+idString+'/up_group';
            window.location.href=url;
        }
    });
</script>
