                ...
                <ul class="nav navbar-nav">
                    <li class="user user-menu">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="hidden-xs">te${user.uV2Phone}</span>
                        </a>
                    </li>
                    <li class="user user-menu">
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                <li><a href="${pageContext.request.contextPath}/u/table"><span>表格录入</span></a></li>
                <li><a href="${pageContext.request.contextPath}/u/history"><span>历史表格</span></a></li>
                <li  class="active"><a href="${pageContext.request.contextPath}/u/psd"><span>修改个人信息</span></a></li>
            </ul>
        </section>
    </aside>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="box box-primary">
                        <div class="box-body">
                            <form action="${pageContext.request.contextPath}/u/change_pw" enctype='multipart/form-data' method="post" id="change_pw">


                                <div class="form-group">
                                    <label >联系人姓名</label>
                                    <input id="name" name="name" type="text" class="form-control"   value="${user1.u2Name}">
                                </div>

                                <div class="form-group">
                                    <label >联系电话</label>
                                    <input id="phone" name="phone" type="text" class="form-control"   value="${user1.u2Phone}">
                                </div>


                                <div class="form-group">
                                    <label >联系邮箱</label>
                                    <input id="mail" name="mail" type="text" class="form-control"   value="${user1.u2Mail}">
                                </div>


                                <div class="form-group">
                                    <label >联系地址</label>
                                    <input id="address" name="address" type="text" class="form-control"   value="${user1.u2Address}">
                                </div>
