                        ...
                        <div class="box-body">
                            <form id="table_up_form" enctype='multipart/form-data' method="post" action="${pageContext.request.contextPath}/teacher/up_table">
                                <div class="table-header">
                                    <h2><input  type="number" id="year" name="year" value="${table.tUserInputYear}" readonly="readonly" />（年份）荣誉证书登记表</h2>
                                </div>
                                <table class="table table-bordered" style="margin-top: -30px">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="10">
                                            ...
                                            <input class="table-inline-input" style="width: 40%" id="tChinaE" name="p" value="${table.tChinaE}"/>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="10">
                                            ...
                                            <input class="table-inline-input" style="width: 40%" id="tWorldE" name="p" value="${table.tWorldE}"/>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5">
                                            ...
                                            <input class="table-inline-input" style="width: 68%" id="tPhone" name="p" value="${table.tPhone}"/>
                                        </td>
                                        <td colspan="5">
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            ...
                                            <input class="table-inline-input" style="width: 68%" id="tWho" name="p" value="${table.tWho}"/>
                                        </td>
                                        <td colspan="5">
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            ...
                                            <input class="table-inline-input" style="width: 73%" id="tAddress" name="p" value="${table.tAddress}"/>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="8">
                                            ...
                                            <input class="table-inline-input" style="width: 86%" id="tGoReason" name="p" value="${table.tGoReason}"/>
                                        </td>
                                    </tr>
